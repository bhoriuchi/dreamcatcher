...
module.exports = function(config) {
	...
	// import handlers
	mods.handlers = require('./handlers')(mods);
	...
	var dreamcatcher = {
		...
		config:      config,
		registry: 	 registry,
		route:       mods.core.route,
		getRoutes: 	 mods.core.route.getRoutes,
		staticRoute: mods.core.route.staticRoute,
		hbsRoute:    mods.core.route.hbsRoute,
