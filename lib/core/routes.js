	...
	function getRoutes(schemas) {
		...
		_.forEach(schemas, function(schemaVersion) {
			...
			if (versions.indexOf(version) !== -1) {
				...
				// create the models
				factory.create(schema, {version: version});
				

				// loop through the schema and get the routes
				_.forEach(factory.models(version)._schema, function(tableSchema, tableName) {
					...
					if (tableSchema.hasOwnProperty(FIELD.rest)) {
						...
						factory.models(version)._schema[tableName]._path = {
							path: basePathUri
						};
						...
						if (tableSchema._rest.hasOwnProperty(FIELD.methods)) {
							...
							_.forEach(tableSchema[FIELD.rest][FIELD.methods], function(opts, method) {
								...
								if (method === METHOD.GET || method === METHOD.HEAD) {
									...
									handle = handlers.select.handle(factory.models(version), tableName, opts,
											handlers.getAll.handle(factory.models(version), tableName, opts));
									...
									handle = handlers.select.handle(factory.models(version), tableName, opts,
											handlers.getId.handle(factory.models(version), tableName, opts));
								...
								// post function
									...
									handle = handlers.select.handle(factory.models(version), tableName, opts,
											handlers.post.handle(factory.models(version), tableName, opts));
								...
								// put function
									...
									handle = handlers.select.handle(factory.models(version), tableName, opts,
											handlers.put.handle(factory.models(version), tableName, opts));
								...
								// delete function
									...
									handle = handlers.select.handle(factory.models(version), tableName, opts,
											handlers.del.handle(factory.models(version), tableName, opts));
